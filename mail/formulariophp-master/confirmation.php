...
<body>
    <div class="container">
        ...
        if (form_mail("agustinngomezdeltoro@gmail.com", $_POST['asunto'], "Les données saisies dans le formulaire sont :\n\n", $_POST['email']))
            echo "=
        <div class='py-5 text-center'>
            <div class='card'>
                ...
                <div class='alert alert-success'>
                    <strong>Confirmation d'expédition</strong> Votre message a été envoyé.
                </div>
            </div>
        </div>
