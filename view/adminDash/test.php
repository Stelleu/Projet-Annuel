                ...
                <div class="multisteps-form mb-5">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 m-auto">
                            <form class="multisteps-form__form" action="">
                                    ...
                                    <div class="multisteps-form__content">
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-12 col-sm-8 mt-4 mt-sm-0 text-start">
                                                ...
                                                <label>Prix</label>
                                                <input class="multisteps-form__input form-control" type="number" id="price" name="price" placeholder="-10%" />
                                                <label>Description</label>
                                                <textarea class="multisteps-form__input form-control" type="text" id="description" placeholder="Description de l'offre" name="description"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="multisteps-form__content">
                                        <div class="row mt-4">
                                            <div class="col-sm-3 ms-auto">
                                                <input type="checkbox" class="btn-check" id="btncheck1" name='time[]' value="semaine">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="checkbox" class="btn-check" name='time[]' value="mois" id="btncheck2">
                                            ...
                                            <div class="col-sm-3 me-auto">
                                                <input type="checkbox" class="btn-check" id="btncheck3" name='time[]' value="0">
                                    ...
                                    <div class="multisteps-form__content">
                                        ...
                                        <div class="row">
                                            <div class="button-row d-flex mt-4 col-12">
                                                <button class="btn bg-gradient-light mb-0 js-btn-prev" type="button" title="Prev">Prev</button>
                                                <button class="btn bg-gradient-dark ms-auto mb-0" type="submit" name="submit" title="Send">Send</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
