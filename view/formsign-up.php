...
ob_start(); ?>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 text-center mx-auto">
                            <h1 class="text-white mb-2 mt-5">Bienvenue sur notre Tableau de bord !</h1>
                            <p class="text-lead text-white">Créer vous un compte administrateur, qui vous donnera accès à toute la gestion d'EASY SCOOTER.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card z-index-0">
                                ...
                                <div class="card-body">
                                    <form role="form text-left">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" class="form-control" placeholder="Nom" aria-label="lastname" name="lastname" aria-describedby="email-addon">
                                        </div>
                                        <div class="mb-3">
                                            <input type="email" class="form-control" placeholder="Email" aria-label="Email" name="email" aria-describedby="email-addon">
                                        </div>
                                        <div class="mb-3">
                                            <input type="tel"  class="form-control" placeholder="Phone" aria-label="Phone" name="phone" aria-describedby="email-addon">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <input type="password" class="form-control" placeholder="Confirmation du mot de passe" aria-label="passwordConfirm" name="passwordConfirm" aria-describedby="password-addon">
                                        </div>
                                        <div class="form-check form-check-info text-left">
                                            <input class="form-check-input" type="checkbox" value="check" id="flexCheckDefault" name="cgu" checked>
                                            <label class="form-check-label" for="flexCheckDefault">
                                                J'accepte les <a href="javascript:;" class="text-dark font-weight-bolder">Conditions d'Utilisation</a>
                                            </label>
                                        </div>
 ...
 <?php $adminsignup = ob_get_clean();
 require(__DIR__.'\..\adminTemplate\pages\sign-up.php'); ?>